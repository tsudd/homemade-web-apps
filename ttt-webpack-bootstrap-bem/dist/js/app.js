...
class Table {
  ...
  restartGame() {
    ...
    for (let i = 0; i < this.cells.length; i++) {
      ...
      $(this.cells[i].cell).removeClass([ticClass, tacClass]); // can be wrong I guess
    }
  }
  ...
  fillCell(cellElement) {
    for (let i = 0; i < this.cells.length; i++) {
      if (this.cells[i].cell === cellElement) { // doesn't work
